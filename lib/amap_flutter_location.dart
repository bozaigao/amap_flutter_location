...
class AMapFlutterLocation {
  ...
  ///添加地理围栏
  Future<int>  addGeoFence(String keyword, String poiType, String city, int size,
      String customId) async{
    return await _methodChannel.invokeMethod('addGeoFence', {
  ...
  void removeGeoFence(){
    _methodChannel.invokeMethod('removeGeoFence', {
      'pluginKey': _pluginKey,
    });
    return;
  }
